...
<form method="POST" action="">
    ...
    <div class="row">
        <?php
         ...
         $g=$_SESSION['gmail1'];
         $one=$_SESSION['one'];
         $sql=mysqli_query($connect,"select * from  normaltshirt where name= '$c'");
    ...
    <div class="row">
        ...
        <?php
         while($row=mysqli_fetch_assoc($sql))
         {
            ...
            $image_src = $row['image'];
            echo '<br><img src=upload/'.$image_src.' height="400px" width="350px">';
            echo '</p>';
         }
        ?>
        </div>
        <div class="col-4 offset-2"><br>
            ...
            <input type="text" name="" value="Rs <?php echo $one ?>" class="form-control" disabled/><br>
            <h5>Total Amount:</h5>
    ...
    $sql=mysqli_query($connect,"select * from  totalproduct where tshirt='normal'");
        ...
        {$a=$g;
            ...
            if (mail($to_email, $subject, $body, $headers)) {
                ...
                echo '   <meta http-equiv = "refresh" content = "0; url =finalpage1.php" />';
            } else {
